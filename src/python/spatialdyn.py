##
# @package spatialdyn
# spatial_dyn Python bindings

##
# @defgroup py Python
# Python bindings for spatial_dyn generated by Pybind11.
# @see C++: \ref cpp

##
# @defgroup py_structs Structs
# @ingroup py
# Python bindings for spatial_dyn structs generated by Pybind11.
# @see C++: \ref cpp_structs

##
# @ingroup py_structs
# Python bindings for the articulated body struct generated by Pybind11.
# @see C++: spatial_dyn::ArticulatedBody
class ArticulatedBody:

    ## Constructor that sets the name of the articulated body.
    # @param name str
    # @see C++: spatial_dyn::ArticulatedBody::ArticulatedBody(const std::string&)
    def __init__(self, name = ""):
        pass

    ## Name of the articulated body for debugging purposes.
    # @see C++: spatial_dyn::ArticulatedBody::name
    name = ""
    ...
    # @param idx_link int
    # @see C++: spatial_dyn::ArticulatedBody::AddLoad()
    ...
    # @see C++: spatial_dyn::ArticulatedBody::inertia_load()
    inertia_load = {}

    ## Transform from the articulated body's base frame to the world frame.
    # @see C++: spatial_dyn::ArticulatedBody::T_base_to_world()
    ...
    # @see C++: spatial_dyn::ArticulatedBody::T_to_parent()
    ...
    # @param q float or None (for cached transform)
    # @return spatialdyn.eigen.Isometry3d
    # @see C++: spatial_dyn::ArticulatedBody::T_from_parent()
    ...
    # @return spatialdyn.eigen.Isometry3d
    # @see C++: spatial_dyn::ArticulatedBody::T_to_world()
    ...
    # @param q numpy.ndarray[float64[n]] or None (for cached transform)
    # @return spatialdyn.eigen.Isometry3d
    # @see C++: spatial_dyn::ArticulatedBody::T_from_world()
    ...
    # @param i int
    # @return List[int]
    # @see C++: spatial_dyn::ArticulatedBody::ancestors()
    ...
    # @param i int
    # @return List[int]
    # @see C++: spatial_dyn::ArticulatedBody::subtree()
    def subtree(self, i):
        pass
    ...
    # @see C++: spatial_dyn::ArticulatedBody::Map()
    ...
    # @see C++: spatial_dyn::operator<<(std::ostream&, const ArticulatedBody&)
    def __repr__(self):
        pass
...
class RigidBody:
    ...
    # @see C++: spatial_dyn::operator<<(std::ostream&, const RigidBody&)
    def __repr__(self):
        pass
...
# @see C++: spatial_dyn::Joint
class Joint:

    ## Constructor that sets the joint type.
    # @param type str
    # @see C++: spatial_dyn::Joint::Joint(const std::string&)
    ...
    # @see C++: spatial_dyn::Joint::is_prismatic()
    is_prismatic = False

    ## Boolean indicating whether the joint is revolute.
    # @see C++: spatial_dyn::Joint::is_revolute()
    is_revolute = False

    ## Lower joint limit.
    # @see C++: spatial_dyn::Joint::q_min()
    q_min = -float("inf")

    ## Upper joint limit.
    # @see C++: spatial_dyn::Joint::q_max()
    q_max = float("inf")

    ## Set the lower and upper joint limits.
    # @see C++: spatial_dyn::Joint::set_q_limits()
    def set_q_limits(q_min, q_max):
        pass

    ## Maximum joint velocity.
    # @see C++: spatial_dyn::Joint::dq_max
    dq_max = float("inf")

    ## Maximum joint torque.
    # @see C++: spatial_dyn::Joint::fq_max
    fq_max = float("inf")

    ## Coulomb friction coefficient.
    # @see C++: spatial_dyn::Joint::f_coulomb
    f_coulomb = 0.0

    ## Viscous friction coefficient.
    # @see C++: spatial_dyn::Joint::f_viscous
    f_viscous = 0.0

    ## Stiction friction coefficient.
    # @see C++: spatial_dyn::Joint::f_stiction
    f_stiction = 0.0

    ## Compute the transform from the joint frame to its parent rigid body's frame.
    # @see C++: spatial_dyn::Joint::T_joint()
    def T_joint(q):
        pass
...
# @ingroup py
# Python bindings for spatial_dyn algorithms generated by Pybind11.
# @see C++: \ref cpp_algorithms

##
# @defgroup py_forward_kinematics Forward Kinematics
# @ingroup py_algorithms
# Python bindings of spatial_dyn forward kinematics algorithms generated by Pybind11.
...
# @see C++: spatial_dyn::CartesianPose()
...
# @see C++: spatial_dyn::LinearJacobian()
...
# @param offset numpy.ndarray[float64[3]]
# @return numpy.ndarray[float64[3, n]]
# @see C++: spatial_dyn::AngularJacobian()
...
# @ingroup py_algorithms
# Python bindings of spatial_dyn inverse dynamics algorithms generated by Pybind11.
...
# @return numpy.ndarray[float64[n]]
# @see C++: spatial_dyn::InverseDynamics()
...
# @param ab spatialdyn.ArticulatedBody
# @return numpy.ndarray[float64[n]]
# @see C++: spatial_dyn::CentrifugalCoriolis()
...
# @param f_external Dict[int, spatialdyn.SpatialForced]
# @return numpy.ndarray[float64[n]]
# @see C++: spatial_dyn::ExternalTorques()
...
# @ingroup py_algorithms
# Python bindings of spatial_dyn forward dynamics algorithms generated by Pybind11.
...
# @param stiction_epsilon float
# @return numpy.ndarray[float64[n]]
# @see C++: spatial_dyn::ForwardDynamics()
...
# @param stiction_epsilon float
# @return numpy.ndarray[float64[n]]
# @see C++: spatial_dyn::ForwardDynamicsAba()
...
# @see C++: spatial_dyn::InertiaInverse()
...
# @param ab spatialdyn.ArticulatedBody
# @return numpy.ndarray[float64[n, n]]
# @see C++: spatial_dyn::InertiaInverseAba()
...
##
# @defgroup py_simulation Simulation
# @ingroup py
# Python bindings of spatial_dyn simulation utilities generated by Pybind11.
# @see C++: \ref cpp_simulation
# @{
...
# @param centrifugal_coriolis bool
# @param friction bool
# @param joint_limits bool
# @param method str
# @param aba bool
# @param stiction_epsilon float
# @see C++: spatial_dyn::Integrate()
def integrate(ab, tau, dt, f_external = {}, gravity = True,
              centrifugal_coriolis = True, friction = True, joint_limits = False,
              method = "RK4", aba = False, stiction_epsilon = 0.01):
    pass

##
# @}

# defgroup py_simulation
