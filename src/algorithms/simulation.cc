...
void Integrate(ArticulatedBody &ab, const Eigen::VectorXd& tau, double dt,
  ...
  Eigen::VectorXd q_0 = ab.q();
   dq[0] = ab.dq();
  ddq[0] = f(ab, tau, f_external, gravity, centrifugal_coriolis, friction);
  ...
  switch (method) {
    ...
    case IntegrationMethod::HEUNS:
      ...
      ab.set_dq(dq[0] + dt * ddq[0]);
       dq[1] = ab.dq();
      ddq[1] = f(ab, tau, f_external, gravity, centrifugal_coriolis, friction);
    ...
    case IntegrationMethod::RK4:
      ...
      ab.set_dq(dq[0] + 0.5 * dt * ddq[1]);
       dq[2] = ab.dq();
      ddq[2] = f(ab, tau, f_external, gravity, centrifugal_coriolis, friction);

      ab.set_q(  q_0  + dt *  dq[2]);
      ab.set_dq(dq[0] + dt * ddq[2]);
       dq[3] = ab.dq();
      ddq[3] = f(ab, tau, f_external, gravity, centrifugal_coriolis, friction);
