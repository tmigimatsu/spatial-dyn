...
template<typename Scalar>
SpatialInertiaMatrix<Scalar>::SpatialInertiaMatrix(const SpatialInertia<Scalar>& other) {
...
template<typename Scalar>
SpatialInertia<Scalar>::SpatialInertia(const SpatialInertia<Scalar>& other)
    : mass(other.mass), com(other.com), I_com(other.I_com) {}

template<typename Scalar>
SpatialInertia<Scalar>::SpatialInertia(SpatialInertia<Scalar>&& other)
